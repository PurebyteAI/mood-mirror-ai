...
## Architecture
- **Backend**: FastAPI (Python) with OpenRouter Qwen3-VL integration
- **Frontend**: React with Tailwind CSS, Framer Motion, Recharts, dark immersive theme
- **Database**: Local SQLite (mood_analyses + mood_journal tables)
- **AI**: Qwen3-VL (qwen/qwen3-vl-235b-a22b-thinking) via OpenRouter API — text + vision (multimodal)
...
- [x] Qwen3-VL integration for mood analysis
...
- [x] Drawing Vision Analysis via OpenRouter multimodal image input (base64 data URL)
...
- [x] AI responds in selected language (German responses from Qwen3-VL)
